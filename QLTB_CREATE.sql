...
(
	...
	note ntext,
	reportStatus int default 0, --0: ch?a ???c nh?n tin, 1: ch?a x? lý, 2: ?ã x? lý, 3: báo cáo sai
	reportedDate datetime default getDate(),
	isEdit bit default 1 --0: không ???c ch?nh s?a, 1: ???c phép ch?nh s?a
)
go
...
(
	...
	responseType int not null, --1: ?ã nh?n tin, 2: ?ã x? lý, 3: thông tin c?a báo cáo sai
